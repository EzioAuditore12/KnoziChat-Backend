...
import type { CreatePrivateChats } from "@/routes/chats/private-chat.route";
import { eq } from "drizzle-orm";

export const createPrivateChat: AuthenticatedAppRouteHandler<
	CreatePrivateChats
> = async (c) => {
	...
	for (const chat of existingChats) {
		...
		if (
			...
			return c.json(
				{ message: "Private chat already exists", chatId: chat.id },
