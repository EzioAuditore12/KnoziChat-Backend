...
export const changeUserPasswordRequestBody = z.object({
    ...
    newPassword: z
        .string()
        .max(64)
        .refine((input) => validator.isStrongPassword(input, {
        minLength: 8,
        minLowercase: 1,
        minNumbers: 1,
        minSymbols: 1,
        ...
        message: "The password should be at least 8 characters long and include uppercase, lowercase, number, and symbol.",
    }),
    verificationRequestToken: z.string().uuid(),
});
